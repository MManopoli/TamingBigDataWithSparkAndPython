# Objective is to find the minimum temperature observed by various weather stations in the year 1800
...
# Use the parseLine fucntion defined above to parse the data into a usable RDD
